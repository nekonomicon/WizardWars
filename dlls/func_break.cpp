...
//			m_iShards = atof(pkvd->szValue);
	...
	else if( ParseSettings( pkvd->szKeyName, pkvd->szValue ) )
		pkvd->fHandled = TRUE;
...
// XYPHN - 030723
//	Replaced by TF override
//LINK_ENTITY_TO_CLASS( func_breakable, CBreakable );
LINK_ENTITY_TO_TF( func_breakable, CBreakable, TFEntity );
...
//	CBaseEntity *pEntity = NULL;
	...
	// 1.2.5 Crash when breakables removed #12
	TFRemove();
}
