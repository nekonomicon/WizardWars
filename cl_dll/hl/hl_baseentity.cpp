...
int CBaseEntity :: IRelationship( CBaseEntity * pOther ) { return 0; }
...
void CBasePlayer::RemoveAllItems( BOOL removeSuit, BOOL removeAmmo ) { }
...
void CBasePlayer::SetSpeed( int, bool ) { }
void CBasePlayer::PainSound( int bitsDamageType ) { }
