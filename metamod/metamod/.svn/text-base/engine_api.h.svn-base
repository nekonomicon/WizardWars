...
extern void *mm_PvAllocEntPrivateData(edict_t *pEdict, int cb);
...
extern unsigned int mm_FunctionFromName( const char *pName );
extern const char *mm_NameForFunction( unsigned int function );
...
extern int mm_RandomLong(int lLow, int lHigh);
